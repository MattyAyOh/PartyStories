...
@interface PSActivityCell ()

/*! Private view components */
@property (nonatomic, strong) PSProfileImageView *activityImageView;
...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        horizontalTextSpace = [PSActivityCell horizontalTextSpaceForInsetWidth:0];
        ...
        self.activityImageView = [[PSProfileImageView alloc] init];
...
- (void)setActivity:(PFObject *)activity {
    ...
    NSString *activityString = [PSActivityFeedViewController stringForActivityType:(NSString*)[activity objectForKey:kPAPActivityTypeKey]];
    ...
    if (self.user) {
        CGSize nameSize = [self.nameButton.titleLabel.text boundingRectWithSize:CGSizeMake(nameMaxWidth, CGFLOAT_MAX)
                                                     ...
                                                     attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:13.0f]}
                                                        context:nil].size;
        NSString *paddedString = [PSBaseTextCell padString:activityString withFont:[UIFont systemFontOfSize:13.0f] toWidth:nameSize.width];
...
- (void)setCellInsetWidth:(CGFloat)insetWidth {
    ...
    horizontalTextSpace = [PSActivityCell horizontalTextSpaceForInsetWidth:insetWidth];
}
...
- (id<PSActivityCellDelegate>)delegate {
    return (id<PSActivityCellDelegate>)_delegate;
}

- (void)setDelegate:(id<PSActivityCellDelegate>)delegate {
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content cellInsetWidth:(CGFloat)cellInset {
    CGSize nameSize = [name boundingRectWithSize:CGSizeMake(200.0f, CGFLOAT_MAX)
                                                 ...
                                                 attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:13.0f]}
                                                    context:nil].size;
    NSString *paddedString = [PSBaseTextCell padString:content withFont:[UIFont systemFontOfSize:13.0f] toWidth:nameSize.width];
    CGFloat horizontalTextSpace = [PSActivityCell horizontalTextSpaceForInsetWidth:cellInset];
