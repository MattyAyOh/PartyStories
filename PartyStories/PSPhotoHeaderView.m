...
@property (nonatomic, strong) PSProfileImageView *avatarImageView;
...
- (id)initWithFrame:(CGRect)frame buttons:(PSPhotoHeaderButtons)otherButtons {
    ...
    if (self) {
        [PSPhotoHeaderView validateButtons:otherButtons];
        ...
        if (self.buttons & PSPhotoHeaderButtonsComment) {
            // comments button
        ...
        if (self.buttons & PSPhotoHeaderButtonsLike) {
            // like button
        ...
        if (self.buttons & PSPhotoHeaderButtonsUser) {
...
+ (void)validateButtons:(PSPhotoHeaderButtons)buttons {
    if (buttons == PSPhotoHeaderButtonsNone) {
