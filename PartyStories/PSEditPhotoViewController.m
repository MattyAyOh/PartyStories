...
@interface PSEditPhotoViewController ()
...
@implementation PSEditPhotoViewController
...
- (void)loadView {
    ...
    CGRect footerRect = [PSPhotoDetailsFooterView rectForView];
    footerRect.origin.y = photoImageView.frame.origin.y + photoImageView.frame.size.height;

    PSPhotoDetailsFooterView *footerView = [[PSPhotoDetailsFooterView alloc] initWithFrame:footerRect];
...
- (void)doneButtonAction:(id)sender {
    ...
    [photo saveInBackgroundWithBlock:^(BOOL succeeded, NSError *error) {
        if (succeeded) {
            [[PSCache sharedCache] setAttributesForPhoto:photo likers:[NSArray array] commenters:[NSArray array] likedByCurrentUser:NO];
            ...
            if (userInfo) {
                ...
                if (commentText && commentText.length != 0) {
                    ...
                    [[PSCache sharedCache] incrementCommentCountForPhoto:photo];
                }
            }
