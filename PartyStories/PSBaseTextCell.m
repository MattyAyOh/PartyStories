...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        horizontalTextSpace =  [PSBaseTextCell horizontalTextSpaceForInsetWidth:cellInsetWidth];
        ...
        self.avatarImageView = [[PSProfileImageView alloc] init];
...
- (void)drawRect:(CGRect)rect {
    ...
    if (self.cellInsetWidth != 0) {
        [PSUtility drawSideDropShadowForRect:mainView.frame inContext:UIGraphicsGetCurrentContext()];
    }
}
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content {
    return [PSBaseTextCell heightForCellWithName:name contentString:content cellInsetWidth:0];
}
...
+ (CGFloat)heightForCellWithName:(NSString *)name contentString:(NSString *)content cellInsetWidth:(CGFloat)cellInset {
    ...
    NSString *paddedString = [PSBaseTextCell padString:content withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
    CGFloat horizontalTextSpace = [PSBaseTextCell horizontalTextSpaceForInsetWidth:cellInset];
...
- (void)setContentText:(NSString *)contentString {
    ...
    if (self.user) {
        CGSize nameSize = [self.nameButton.titleLabel.text boundingRectWithSize:CGSizeMake(nameMaxWidth, CGFLOAT_MAX)
                                                     ...
                                                     attributes:@{NSFontAttributeName:[UIFont boldSystemFontOfSize:13.0f]}
                                                        context:nil].size;
        NSString *paddedString = [PSBaseTextCell padString:contentString withFont:[UIFont systemFontOfSize:13] toWidth:nameSize.width];
...
- (void)setCellInsetWidth:(CGFloat)insetWidth {
    ...
    horizontalTextSpace = [PSBaseTextCell horizontalTextSpaceForInsetWidth:insetWidth];
    [self setNeedsDisplay];
}
...
- (id<PSBaseTextCellDelegate>)delegate {
    return (id<PSBaseTextCellDelegate>)delegate;
}

- (void)setDelegate:(id<PSBaseTextCellDelegate>)aDelegate {
