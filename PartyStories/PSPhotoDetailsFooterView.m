...
@interface PSPhotoDetailsFooterView ()
@property (nonatomic, strong) UIView *mainView;
@end

@implementation PSPhotoDetailsFooterView
...
- (void)drawRect:(CGRect)rect {
    ...
    if (!hideDropShadow) {
        [PSUtility drawSideAndBottomDropShadowForRect:mainView.frame inContext:UIGraphicsGetCurrentContext()];
    }
}
